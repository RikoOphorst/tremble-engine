...
namespace tremble
{
	...
	//------------------------------------------------------------------------------------------------------
	void ColorBuffer::CreateFromSwapChain(const std::wstring& name, ID3D12Resource* swap_chain_resource)
	{
	...
	//------------------------------------------------------------------------------------------------------
	void ColorBuffer::Create(const std::wstring& name, UINT width, UINT height, DXGI_FORMAT format)
	{
